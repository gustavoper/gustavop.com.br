...
<head>
    ...
    <title>Gustavo Pereira - PHP Senior Developer</title>
...
<div id="skipnav"><a href="#maincontent">Top</a></div>
    ...
    <section class="skillset">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-2"><img src="img/php-logo.png"></div>
                <div class="col-lg-2"><img src="img/mysql-logo.png"></div>
                <div class="col-lg-2"><img src="img/js-logo.png"></div>
                <div class="col-lg-2"><img src="img/zf2-logo.png"></div>
                <div class="col-lg-2"><img src="img/linux-logo.png"></div>
                <div class="col-lg-2"><img src="img/zf-englogo.png"></div>
    ...
    <footer class="text-center">
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-4">
                        <h3>Location</h3>
                        <p>Cubatão, São Paulo, Brazil<br>
                           <em>Willing to relocate? Yes</em><br>
                            <em>Can work remotely? Yes</em>
                        </p>
                    </div>
                    <div class="footer-col col-md-8" id="social-contact">
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; Gustavo Pereira 2016 <br>
                        Template by <a href="https://startbootstrap.com/template-overviews/freelancer/">StartBootstrap</a>
                    </div>
                </div>
            </div>
        </div>
